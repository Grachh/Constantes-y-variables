...
-----------------------------------------------------------------------------------------------------------------------
  ...
  System.out.println ("La altura es: " + altura + " cms");
  
  /*  EJEMPLO DE ERROR AL INTENTAR MODIFICAR UNA CONSTANTE
 */
  altura = 12;  // Static Error: Variable 'altura' cannot be modified
 
  
  double peso = 87.5; //Kilogramos
  System.out.println ("El peso (double) es: " + peso + " Kilogramos");
